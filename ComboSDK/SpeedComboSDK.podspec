#
#  Be sure to run `pod spec lint SpeedComboSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  spec.name                 = "SpeedComboSDK"
  spec.version              = "1.0.3"
  spec.summary              = "SpeedComboSDK 测速网综合测试SDK"
  ...
  spec.source               = { :http => "https://file2.speedtest.cn/v3/2022-03-09/235432535.zip" }
  valid_archs               = ['x86_64', 'arm64']
  spec.frameworks           = 'UIKit'
  spec.vendored_frameworks  = "speedcombosdk/ComboSDK.framework"
  spec.resource             = 'speedcombosdk/GameComboSDK.bundle'
