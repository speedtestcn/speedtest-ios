#
#  Be sure to run `pod spec lint SpeedTestKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  spec.name                 = "SpeedTestKit"
  spec.version              = "1.4.3"
  spec.summary              = "SpeedTestKit 测速网测速SDK 无UI版本"
  ...
  spec.vendored_frameworks  = "speedsdk/SpeedTestKit.framework"
